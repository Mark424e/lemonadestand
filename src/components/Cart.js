  ...
  return (
    showModal && (
      <div className="flex-col flex items-center fixed bottom-0 left-0 w-full h-3/4 bg-gradient-to-br from-indigo-900/50 via-purple-900/50 to-pink-900/50 backdrop-blur p-10 text-black font-normal text-sm">
        <h1 className="text-white text-2xl font-bold mb-10">Cart</h1>
        ...
        <div className="flex flex-col w-[100%] px-10 gap-4 text-white">
          {cartItems.map((item) => (
            <div className="transition rounded duration-300 ease-in-out hover:bg-white/30 hover:text-white transform hover:scale-105 flex justify-between items-center" key={item.id}>
